...
#define AP_MOTORS_HELI_COMPOUND_AUX_2                            CH_7
#define AP_MOTORS_HELI_COMPOUND_AUX_1                            CH_6
...
#define AP_MOTORS_HELI_COMPOUND_TAIL_RAMP_INCREMENT              5       // 5 is 2 seconds for direct drive tail rotor to reach to full speed (5 = (2sec*100hz)/1000)
...
public:
    ...
    AP_MotorsHeli_Compound(RC_Channel&    servo_aux_1,
        ...
        _yaw_servo_1(servo_4),
        _yaw_servo_2(servo_5),
        _main_rotor(servo_rsc, AP_MOTORS_HELI_COMPOUND_RSC, loop_rate),
        _tail_rotor_1(servo_aux_1, AP_MOTORS_HELI_COMPOUND_AUX_1, loop_rate),
        _tail_rotor_2(servo_aux_2, AP_MOTORS_HELI_COMPOUND_AUX_2, loop_rate)
    {
    ...
    bool supports_yaw_passthrough() const { return _tail_type == AP_MOTORS_HELI_COMPOUND_TAILTYPE_SERVO_EXTGYRO; }
...
protected:
    ...
    RC_Channel&     _servo_aux_1;                 // output to ext gyro gain and tail direct drive esc (ch7)
    ...
    RC_Channel&     _yaw_servo_1;                 // tail servo
    RC_Channel&     _yaw_servo_2;                 // tail servo


    AP_MotorsHeli_RSC   _main_rotor;            // main rotor
    AP_MotorsHeli_RSC   _tail_rotor_1;            // tail rotor
    AP_MotorsHeli_RSC   _tail_rotor_2;            // tail rotor
